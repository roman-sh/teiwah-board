...
import type { BaileysStatus } from "@/hooks/use-session-stream"
import { cn } from "@/lib/utils"

export type OnboardingPhase = "setup" | "scan" | "pairing"
...
function OnboardingStepIndicator({ phase }: { phase: OnboardingPhase }) {
  ...
  return (
    <div className="mb-8 flex w-full max-w-[280px] items-center justify-center gap-2">
        ...
        <div key={step.key} className="flex items-center gap-2">
          <div className="flex flex-col items-center gap-1">
            <div className="relative flex size-7 items-center justify-center">
              ...
              <div
                className={cn(
                  "relative z-10 flex h-7 w-7 items-center justify-center rounded-full border text-xs font-medium transition-colors",
                  index < activeIndex &&
          ...
          {index < ONBOARDING_STEPS.length - 1 && (
            <div className="relative mb-4 h-px w-8 overflow-hidden bg-muted-foreground/20">
              <motion.div
...
type SessionOnboardingModalProps = {
  sessionId: string
...
export function SessionOnboardingModal({
  sessionId,
  phase,
  qr,
  status,
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-background/80 p-4 backdrop-blur-sm">
      <div className="flex w-full max-w-md flex-col items-stretch gap-2">
        ...
        <Card
          className={cn(
            "relative w-full p-8 pt-10 text-center shadow-lg",
        ...
        >
          ...
          {phase === "pairing" && (
            <>
              ...
              <p className="shrink-0 pb-1 text-sm font-medium text-foreground">
                Linking your phone…
              </p>
            </>
          )}
